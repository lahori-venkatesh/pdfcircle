        ...
        runtimeCaching: [
          {
            ...
            handler: 'CacheFirst',
            options: { cacheName: 'opencv-cache', expiration: { maxEntries: 5, maxAgeSeconds: 60 * 60 * 24 * 5 }, cacheableResponse: { statuses: [0, 200] } }
          },
          {
            urlPattern: /\.(js|css|woff2|json|wasm)$/i,
            handler: 'StaleWhileRevalidate',
            options: { cacheName: 'static-resources', expiration: { maxEntries: 30, maxAgeSeconds: 60 * 60 * 24 * 2 } }
          },
          {
