...
function Layout({ children }: PropsWithChildren<{}>) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-[120px] sm:bottom-[150px] right-8 p-3 bg-indigo-600 text-white rounded-full shadow-lg hover:bg-indigo-700 transition-all duration-300 z-60 ${isVisible ? 'opacity-100' : 'opacity-0'} ${isVisible ? 'translate-y-0' : 'translate-y-10'}`}
