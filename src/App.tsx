...
function HomePage() {
  ...
  return (
    <>
      <SEOHeaders 
        title={t('seo.home.title', 'Free Online PDF & Image Tools | Convert, Compress, Merge & Enhance Files')}
        description={t('seo.home.description', 'All-in-One Online PDF & Image Processing Tool | Convert, Compress, Merge & Enhance for Free')}
        keywords={[
          'pdf converter online', 'image compression tool', 'photo enhancer free',
          'merge pdf files', 'compress images online', 'jpg to pdf converter',
          'image resizer online', 'convert jpg to png online', 'png to jpg converter',
          'image upscaling tool', 'crop images online free', 'ai image enhancement'
        ]}
      />
