...
export function PDFToWord() {
  return (
    <div className="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-6 rounded-lg text-center">
      ...
      <h3 className="text-lg font-semibold mb-2">PDF to Word Coming Soon!</h3>
      <p>
        We're working on bringing you PDF to Word conversion capabilities. Stay tuned for updates!
      </p>
    </div>
  );
}
